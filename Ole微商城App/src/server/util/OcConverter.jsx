function convertBuyItem(buyItem) {
    ...
    item.deliveryWay = buyItem.getDeliveryWay() + "";//配送方式
    item.integralPrice = buyItem.getIntegralPrice() + "";//积分价格
    item.totalIntegralPrice = buyItem.getTotalIntegralPrice() + "";//总积分价格
