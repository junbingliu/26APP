...
if(brandSelector){
self.editorViewModel = brandSelector;
}
else{
$.get("/brandSelector/htmloader.jsx",function(html){
$("body").append(html);
self.editorViewModel = new BrandSelector(configs.m);
ko.cleanNode(document.getElementById("BrandSelector"));
ko.applyBindings(self.editorViewModel,document.getElementById("BrandSelector"));
window["brandSelector"] = self.editorViewModel;
$("#BrandSelector").draggable();
});
};
})({m:"head_merchant"});
