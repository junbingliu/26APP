...
var productSelector = window["productSelector"];
if(productSelector){
self.editorViewModel = productSelector;
}
else{
$.get("/productSelector/htmloader.jsx",function(html){
$("body").append(html);
self.editorViewModel = new ProductSelector(configs.m);
ko.cleanNode(document.getElementById("ProductSelect"));
ko.applyBindings(self.editorViewModel,document.getElementById("ProductSelect"));
window["productSelector"] = self.editorViewModel;
$("#ProductSelect").draggable();
});
};
})({m:'!M'});
