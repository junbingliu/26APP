...
(function () {
    try {
        ...
        postData.findProductNameIndex = jParameters.findProductNameIndex || "";
        postData.findCardBatchIdIndex = jParameters.findCardBatchIdIndex || "";
        postData.findChannelIndex = jParameters.findChannelIndex || "";
        postData.findMarketPriceIndex = jParameters.findMarketPriceIndex || "";
        postData.findMemberPriceIndex = jParameters.findMemberPriceIndex || "";
        postData.beginLine = jParameters.dataBeginLine || "";
        postData.endLine = jParameters.dataEndLine || "";
        var when = (new Date()).getTime();
        var jobPageId = "tasks/BatchAddProductTask.jsx";
