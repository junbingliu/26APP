...
(function (processor) {
    ...
    processor.on("all", function (pageData, dataIds, elems) {
        ...
        var jActivity = {};
        var activity = FreeGetCardService.getActivity(activityId);
        if(activity){
            var longBeginTime = new Date(activity.beginTime);
            var longEndTime = new Date(activity.endTime);

            jActivity.beginTimeTxt = DateUtil.getShortDate(longBeginTime.getTime());
            jActivity.endTimeTxt = DateUtil.getShortDate(longEndTime.getTime());
        }
        ...
        setPageDataProperty(pageData, "activity", jActivity);
    });
