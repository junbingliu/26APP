...
(function () {
    try {
        ...
        postData.findMerchantIdIndex = jParameters.findMerchantIdIndex || "";
        ...
        postData.findPublishStateIndex = jParameters.findPublishStateIndex || "";
        postData.beginLine = jParameters.dataBeginLine || "";
        postData.endLine = jParameters.dataEndLine || "";
        var when = (new Date()).getTime();
        var jobPageId = "tasks/BatchUploadProductTask.jsx";
