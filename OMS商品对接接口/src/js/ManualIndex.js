...
function doSendSkuQuantityToOMS() {
    ...
    $.post("doSendSkuQuantityToOMS.jsx", postData, function (data) {
        if (data.code == 'ok') {
            alert("操作成功");
        } else {
            alert(data.msg);
...
function doSendOneSkuQuantityToOMS() {
    ...
    $.post("doSendOneSkuQuantityToOMS.jsx", postData, function (data) {
        if (data.code == 'ok') {
            alert("操作成功");
        } else {
            alert(data.msg);
...
function doReSendProductToOMS() {
    ...
    $.post("doSendProductToOMS.jsx", postData, function (data) {
        if (data.code == 'ok') {
            alert("操作成功");
        } else {
            alert(data.msg);
...
function doReSendColumnToOMS() {
    ...
    $.post("doSendColumnToOMS.jsx", postData, function (data) {
        if (data.code == 'ok') {
            alert("操作成功");
        } else {
            alert(data.msg);
