...
(function () {
    ...
    var productList = OmsEsbProductService.getO2OQtyExchangeList(merchantId, 0, -1);//获取o2o对接队列
    if (productList.length == 0) {
        productList = OmsEsbProductService.getQtyExchangeList(merchantId, 0, -1);//获取对接队列
        if (productList.length == 0) {
            add2Task(merchantId);
            return;
        }
    ...
    //$.log("\n.............................doSendO2OSkuQuantityToOMS.jsx...8888888888888888888888...productList.length=" + productList.length);
    ...
    for (var k = 0; k < productList.length; k++) {
        ...
        //将商品从对接队列删除
        OmsEsbProductService.deleteFormO2OExchangeList(merchantId, productId);
